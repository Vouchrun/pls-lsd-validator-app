...
export default function ProtocolRevenue() {
  ...
  return (
    <div className='bg-color-bg2 border-[0.01rem] border-color-border1 rounded-[.3rem]'>
        <div className='h-[.7rem] flex items-center justify-center font-[500] border-solid border-b-[.01rem] border-white dark:border-[#1B1B1F] text-[.16rem] text-color-text2'>Protocol Revenue</div>
        <div className={classNames(
          ...
          'bg-bgPage/50 dark:bg-bgPageDark/50'
            ...
            <div className={darkMode ? 'flex items-center justify-between px-[20px] py-[8px] border-b-[0.01rem] border-[#303745] text-[.14rem] text-color-text1' : 'flex items-center justify-between px-[20px] py-[5px] border-b-[0.01rem] border-[#ffffff] text-[.14rem] text-color-text1'}>
                ...
                <div className={robotoSemiBold.className}>74.678 Mil</div>
            </div>
            <div className={darkMode ? 'flex items-center justify-between px-[20px] py-[8px] border-b-[0.01rem] border-[#303745] text-[.14rem] text-color-text1' : 'flex items-center justify-between px-[20px] py-[5px] border-b-[0.01rem] border-[#ffffff] text-[.14rem] text-color-text1'}>
            ...
            <div className={darkMode ? 'flex items-center justify-between px-[20px] py-[8px] border-b-[0.01rem] border-[#303745] text-[.14rem] text-color-text1' : 'flex items-center justify-between px-[20px] py-[5px] border-b-[0.01rem] border-[#ffffff] text-[.14rem] text-color-text1'}>
                ...
                <div className={robotoSemiBold.className}>7.467 Mil</div>
            </div>
            <div className={darkMode ? 'flex items-center justify-between px-[20px] py-[8px] border-b-[0.01rem] border-[#303745] text-[.14rem] text-color-text1' : 'flex items-center justify-between px-[20px] py-[5px] border-b-[0.01rem] border-[#ffffff] text-[.14rem] text-color-text1'}>
                <div className='text-color-text2'>Treasury Balance</div>
                <div className={robotoSemiBold.className}>5.765 Mil</div>
            </div>
            <div className='text-[.14rem] text-color-text1 mt-5 text-center mb-[10px]'>
                <span className='text-color-text2'>Withdrawable Balance:</span> <span className={robotoSemiBold.className}>40.000 Mil PLS</span>
            </div>
            <input type='text' placeholder='Enter Distribution Address' 
            className={darkMode ? 'w-full rounded-[35px] bg-[#1B1B1F] text-center h-[42px] border-[0.01rem] border-[#6C86AD80]' : 'w-full rounded-[35px] bg-[#fff] text-center h-[42px] border-[0.01rem] border-[#6C86AD80]'}
            />
            <div className='mt-[10px] max-w-[250px] mx-auto'>
                <CustomButton
                type='small'
                height='.42rem'>Distribute Commissions</CustomButton>
            </div>
