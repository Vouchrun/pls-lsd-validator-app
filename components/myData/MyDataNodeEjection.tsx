...
export const MyDataNodeEjection = () => {
  ...
  return (
    <div>
      <div className='mt-[48px] flex items-center justify-between flex-col md:flex-row'>
            ...
            >
              <div className='flex items-center'>
                ...
                <div className='ml-[.06rem] rotate-[-90deg]'>
                  <Icomoon icon='arrow-down' size='12px' color='#848B97' />
                </div>
              </div>
            </CustomButton>
          </div>
        ...
        <div>
          <div
            className={classNames(
              'md:mr-[.24rem] cursor-pointer px-[16px] h-[42px] inline-flex items-center justify-between rounded-[30px] border-[0.01rem] mt-[10px] md:mt-0',
          ...
          >
            <div
              className={classNames(
                'flex-1 text-[14px] w-auto flex items-center justify-center',
        ...
        <div className='flex items-center justify-center mt-1 md:flex-row flex-col p-[16px]'>
          <div className='flex items-center'>
            ...
            <select
              ...
              className='cursor-pointer px-[16px] h-[.42rem] inline-flex items-center justify-between rounded-[4px] border-[0.01rem] bg-transparent shadow-none outline-none text-color-text2 border-color-border1'
              style={{ color: '#6C86AD' }}
            >
...
const ChooseTypePopover = (props: any) => {
  ...
  return (
    ...
    >
      <div
        className={classNames('p-[16px] w-[250px]', darkMode ? 'dark' : '')}
      >
        <div
