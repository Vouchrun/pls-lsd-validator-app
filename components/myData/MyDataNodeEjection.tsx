        ...
        <div className='flex items-center justify-center mt-1 md:flex-row flex-col p-[16px]'>
          <div className='flex items-center'>
            ...
            <select
              ...
              className='cursor-pointer px-[16px] h-[.42rem] inline-flex items-center justify-between rounded-[4px] border-[0.01rem] border-[#6C86AD80] bg-transparent shadow-none outline-none'
              style={{ color: '#6C86AD' }}
            >
